...
class function THashSHA1.HashType: THashType;
begin
  Result := THashType.Cryptographic;
end;

function THashSHA1.HashSize: Cardinal;
begin
  Result := 20;
end;

function THashSHA1.BlockSize: Cardinal;
begin
  Result := 64;
end;
...
function THashSHA1.GetPadBuffer: TBytes;
var
  i: Cardinal;
  LengthInBits: UInt64;
  Len: Cardinal;
