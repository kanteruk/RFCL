...
type
  ...
  protected
    ...
    function GetModeMarker: Byte; virtual;
  public
  ...
  protected
    function GetModeMarker: Byte; override;
  end;
...
function THashKeccak.GetModeMarker: Byte;
begin
  Result := $01; // Keccak = $01, CShake = $04, SHA3 = $06, Shake = $1F
end;
...
begin
  ...
  if PadLen = 1 then
    Result[0] := $80 or GetModeMarker
  else if PadLen > 1 then
  begin
    Result[0] := GetModeMarker;
...
function THashSHA3.GetModeMarker: Byte;
begin
  Result := $06;
end;
